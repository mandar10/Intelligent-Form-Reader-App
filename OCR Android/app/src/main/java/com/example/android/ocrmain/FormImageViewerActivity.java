...
public class FormImageViewerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_image_viewer);
        ...
        crop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String prepend = "CIMAGE_" + timestamp + "_";
                File imageFile = null;
                try {
                ...
                UCrop.of(imageUri, destinationUri)
                        ...
                        .start(FormImageViewerActivity.this);
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentnext = new Intent(FormImageViewerActivity.this, UploadActivity.class);
                intentnext.putExtra("CropedImagePath",path);
                intentnext.putExtra("CropStat","0");
                intentnext.putExtra("tempname",tempname);
                intentnext.putExtra("formname",formname.getText().toString());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == UCrop.REQUEST_CROP) {
            ...
            Intent intentnext = new Intent(this, UploadActivity.class);
