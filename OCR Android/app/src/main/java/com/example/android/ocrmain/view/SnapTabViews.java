...
/**
 * Created by prathmeshmhapsekar on 02/12/17.
 */

public class SnapTabViews extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public SnapTabViews(@NonNull Context context) {
        this(context,null);
    }

    public SnapTabViews(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SnapTabViews(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    private void init()
    {
        ...
        mBottomText = (TextView)findViewById(R.id.vst_bottom_text);
    ...
    private void setColor(int pos) {
        if (pos == 0) {
            ...
            mBottomImage.setColorFilter(mOldColor);
            mBottomText.setTextColor(mOldColor);
        ...
        {
            mBottomImage.setColorFilter(mNewColor);
            mBottomText.setTextColor(mNewColor);
